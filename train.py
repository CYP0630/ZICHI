...
def create_gen_wav_para(net):
    with tf.name_scope('infe_para'):
        ...
        infe_para['infe_big_frame_state'] = tf.get_variable(
            "infe_big_frame_state",
            [
                net.batch_size,
                net.dim
            ],
        ...
        infe_para['infe_frame_state'] = tf.get_variable(
            "infe_frame_state",
            [
                net.batch_size,
                net.dim
        ...
        infe_para['infe_final_big_frame_state'] = tf.get_variable(
        ...
        infe_para['infe_final_frame_state'] = tf.get_variable(
            "infe_final_frame_state",
            [
                net.batch_size,
                net.dim
            ],
